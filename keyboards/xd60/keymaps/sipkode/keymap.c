...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
      ...
      KC_NO,   KC_LGUI, KC_LALT,                          KC_SPC,                          KC_NO,   KC_RALT, _______, KC_RGUI, KC_NO),

  [_FN] = LAYOUT_all(
      RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS, KC_DEL,      \
      KC_CAPS, BL_TOGG, BL_DEC,  BL_INC,  _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   _______, _______,                 \
      _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPLY, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, KC_NO,   _______,           \
